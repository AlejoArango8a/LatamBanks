...
export const BANK_PROFILES = {
  ...
  uruguay: {
    ...
    157: {
      shortName: 'BTG Pactual Uruguay',
      legalName: 'BTG Pactual Uruguay S.A.',
      hq: 'Montevideo',
      hqCity: 'Montevideo',
      ownership: 'Subsidiary of BTG Pactual',
      controlling: 'BTG Pactual',
      originCountry: 'BR',
      originCountryName: 'Brazil',
      businessFocus: 'Commercial and private banking under the BTG Pactual franchise',
      history: 'Uruguayan banking franchise of BTG Pactual (formerly operated under the HSBC brand; BCU institution code 157).',
      context: 'BTG franchise in Uruguay; peers include BROU, Itaú, Santander and Scotiabank.',
      website: 'https://www.btgpactual.com',
