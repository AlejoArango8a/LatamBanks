...
import { API_BASE, BTG_LOGO_DARK_SRC, bankColor } from './config.js?v=bmon33';
import { bankName, fmtKPI, periodLabel } from './format.js?v=bmon33';
import { setStatus, showErr } from './utils.js?v=bmon33';
import { sumRows } from './api.js?v=bmon33';
import { syncFinStatementPanelLabels } from './views/balance.js?v=bmon33';
