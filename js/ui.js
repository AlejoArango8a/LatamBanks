...
import { API_BASE, BTG_LOGO_DARK_SRC, bankColor } from './config.js?v=bmon67';
...
import { syncFinStatementPanelLabels } from './views/balance.js?v=bmon67';
import { fetchUSDRate, clearUsdRate, hasUsdRate } from './fx.js?v=bmon67';
export { fetchUSDRate };
