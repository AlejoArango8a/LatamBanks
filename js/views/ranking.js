...
import { paisSystemName } from '../paises.js?v=bmon32';
...
import { FELLER_RATINGS, BANK_RATINGS_CO, BANK_RATINGS_CO_META, RATING_COLORS, btgBlue, btgRgba } from '../config.js?v=bmon32';
import { CO_CUIF } from '../coCuentas.js?v=bmon32';
import { BR_KPI } from '../brCuentas.js?v=bmon32';
import { bankName, fmtKPIDecimal, periodLabel } from '../format.js?v=bmon32';
