...
import { paisSystemName, paisLocale } from '../paises.js?v=bmon64';
...
import { FELLER_RATINGS, BANK_RATINGS_CL_META, BANK_RATINGS_CO, BANK_RATINGS_CO_META, RATING_COLORS, btgBlue, btgRgba } from '../config.js?v=bmon64';
import { CO_CUIF } from '../coCuentas.js?v=bmon64';
import { BR_KPI } from '../brCuentas.js?v=bmon64';
import { UY_KPI } from '../uyCuentas.js?v=bmon64';
import { PE_KPI } from '../peCuentas.js?v=bmon64';
import { US_KPI } from '../usCuentas.js?v=bmon64';
import { AR_KPI } from '../arCuentas.js?v=bmon64';
import { MX_KPI } from '../mxCuentas.js?v=bmon64';
import { PA_KPI } from '../paCuentas.js?v=bmon64';
import { bankName, fmtKPIDecimal, periodLabel } from '../format.js?v=bmon64';
