...
import { paisSystemName } from '../paises.js?v=bmon29';
...
import { FELLER_RATINGS, BANK_RATINGS_CO, BANK_RATINGS_CO_META, RATING_COLORS, btgBlue, btgRgba } from '../config.js?v=bmon29';
import { CO_CUIF } from '../coCuentas.js?v=bmon29';
import { BR_KPI } from '../brCuentas.js?v=bmon29';
import { bankName, fmtKPIDecimal, periodLabel } from '../format.js?v=bmon29';
import { apiDatos } from '../api.js?v=bmon29';
...
export function renderCBTable() {
  ...
  bankData.forEach((b, rowIdx) => {
    const btgCode  = datasetIsoCountry() === 'CO' ? 66 : datasetIsoCountry() === 'BR' ? 30306294 : 59;
