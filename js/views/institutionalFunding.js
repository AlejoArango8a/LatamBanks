...
} from '../clInstFundingCuentas.js?v=bmon99';
...
import { drawLineChart, sparseData, setupChartTooltip } from '../charts.js?v=bmon99';
...
async function loadAgfRegistry() {
  ...
  agfRegistryPromise = fetch(`data/cl_agf_registry.json?v=bmon99`)
