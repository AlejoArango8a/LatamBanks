...
} from '../clInstFundingCuentas.js?v=bmon97';
...
import { drawLineChart, sparseData, setupChartTooltip } from '../charts.js?v=bmon97';
...
async function loadAgfRegistry() {
  ...
  agfRegistryPromise = fetch(`data/cl_agf_registry.json?v=bmon97`)
