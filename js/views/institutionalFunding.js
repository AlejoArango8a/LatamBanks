...
} from '../clInstFundingCuentas.js?v=bmon93';
...
import { drawLineChart, sparseData, setupChartTooltip } from '../charts.js?v=bmon93';
...
async function loadAgfRegistry() {
  ...
  agfRegistryPromise = fetch(`data/cl_agf_registry.json?v=bmon93`)
