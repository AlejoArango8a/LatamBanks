...
} from '../clInstFundingCuentas.js?v=bmon98';
...
import { drawLineChart, sparseData, setupChartTooltip } from '../charts.js?v=bmon98';
...
async function loadAgfRegistry() {
  ...
  agfRegistryPromise = fetch(`data/cl_agf_registry.json?v=bmon98`)
