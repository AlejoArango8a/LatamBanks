...
// ============================================================
import { ST, datasetIsoCountry, reportingLocalCurrencyISO } from '../state.js?v=bmon25';
import { bankColor } from '../config.js?v=bmon25';
import { bankName, fmtKPI, fmtKPIDecimal, fmtM, fmtP, fmtB, fmtChartPct, nplPctFromRaw, coIncomeStatementConceptHtml, escapeHtml } from '../format.js?v=bmon25';
import { sumRows } from '../api.js?v=bmon25';
import { BAL_CO_SECTIONS, coPlStatementRows, coSumB1BalanceRow, coSumR1PlRow } from '../coCuentas.js?v=bmon25';
