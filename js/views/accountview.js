...
import { accountViewLevel } from '../coCuentas.js?v=bmon59';
import { bankName, fmtKPIDecimal, toSentenceCase, getTipo, periodLabel } from '../format.js?v=bmon59';
import { apiDatos } from '../api.js?v=bmon59';
import { btgBlue, btgRgba } from '../config.js?v=bmon59';
