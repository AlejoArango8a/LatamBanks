...
import { accountViewLevel } from '../coCuentas.js?v=bmon98';
import { bankName, fmtKPIDecimal, toSentenceCase, getTipo, periodLabel } from '../format.js?v=bmon98';
import { apiDatos } from '../api.js?v=bmon98';
import { btgBlue, btgRgba } from '../config.js?v=bmon98';
